...
| Cross-reference | [Corpus Coranicum](https://corpuscoranicum.de/) | Academic project (BBAW). Consult their terms. |
| Morphology | [Quranic Arabic Corpus](http://corpus.quran.com/) | GPL-3.0. Used by `MorphologyBrowser`. |
...
scripts/                         # fetch-data, build-variants,
                                 ...
                                 # extract-manuscripts, audit-data,
                                 # init-verification-ledger, match-sources,
                                 # apply-source-matches, record-source-provenance
